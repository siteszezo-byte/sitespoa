...
function MateriaPrimaManager() {
  ...
  useEffect(() => {
    if (editingProduct) {
      const productToEdit = {
        ...editingProduct,
        data_validade: editingProduct.data_validade
          ? editingProduct.data_validade.split("T")[0]
          : "",
        data_recebimento: editingProduct.data_recebimento
          ? editingProduct.data_recebimento.split("T")[0]
          : "",
      };
